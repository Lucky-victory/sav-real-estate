...
import { CheckCircle, ArrowRight, Home, Building, Building2, Briefcase, LineChart, Shield } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Find your dream home or investment property with our expert guidance throughout the buying process.",
      ...
      image: "https://images.pexels.com/photos/7937764/pexels-photo-7937764.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      id: "property-rentals",
      title: "Property Rentals",
      description: "Discover premium rental properties that match your lifestyle and budget with our personalized service.",
      ...
      image: "https://images.pexels.com/photos/8146147/pexels-photo-8146147.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      id: "property-management",
      title: "Property Management",
      description: "Maximize your property's potential with our comprehensive management services for landlords and investors.",
      ...
      image: "https://images.pexels.com/photos/7937742/pexels-photo-7937742.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
    },
    {
      id: "investment-advisory",
      title: "Investment Advisory",
      description: "Make informed real estate investment decisions with our expert market analysis and advisory services.",
      ...
      image: "https://images.pexels.com/photos/7937693/pexels-photo-7937693.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
    },
    {
      id: "market-analysis",
      title: "Market Analysis",
      description: "Stay ahead with our in-depth analysis of the Nigerian real estate market trends and forecasts.",
      ...
      image: "https://images.pexels.com/photos/5816291/pexels-photo-5816291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
    },
    {
      id: "legal-services",
      title: "Legal Services",
      description: "Navigate the legal complexities of real estate transactions with our expert legal support.",
      ...
      image: "https://images.pexels.com/photos/7731397/pexels-photo-7731397.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
    }
  ]
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
              Our streamlined process ensures a smooth and efficient experience for all your real estate needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We create a customized strategy based on your goals, timeline, and budget.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Our team executes the strategy, keeping you informed at every step of the process.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We provide continuous support and follow-up to ensure your complete satisfaction.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md"
            >
              <p className="text-gray-500 dark:text-gray-400 italic shadow-md">
              <p className="text-gray-500 dark:text-gray-400 italic mb-4">
                "Sav Real Estate made my property search incredibly easy. Their team was professional, knowledgeable, and attentive to my specific needs. I found my dream home within weeks!"
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-bold">Oluwaseun Adeyemi</h4>
            ...
            >
              <p className="text-gray-500 dark:text-gray-400 italic mb-4">
                "As a property investor, I've worked with several agencies, but Sav Real Estate stands out. Their market analysis and investment advisory services have helped me make informed decisions and maximize my returns."
              </p>
              <div className="flex items-center">
                <div className="relative h-12 w-12 rounded-full overflow-hidden mr-4">
                  <Image
                ...
                <div>
                  <h4 className="font-bold">Ibrahim Musa</h4>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Abuja, Nigeria
                  </p>
                </div>
