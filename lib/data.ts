...
export const featuredProperties: PropertyType[] = [
  {
    ...
    description: "Stunning 4 bedroom villa with private pool and garden in a secure estate.",
    price: 250000000,
    location: "Ikoyi, Lagos",
    imageUrl: "https://cdn.pixabay.com/photo/2019/10/17/02/39/villa-4555824_1280.jpg",
    status: "For Sale",
    bedrooms: 4,
    bathrooms: 5,
    size: 450,
    isNew: true,
    features: ["Swimming Pool", "Garden", "Security", "Garage", "Air Conditioning"],
  },
  {
    id: "prop2",
    title: "Modern 3 Bedroom Apartment",
    description: "Beautifully designed 3 bedroom apartment with stunning city views.",
    price: 120000000,
    location: "Victoria Island, Lagos",
    imageUrl: "https://cdn.pixabay.com/photo/2023/05/18/05/18/home-8001359_1280.jpg",
    status: "For Sale",
    bedrooms: 3,
    bathrooms: 3,
    size: 210,
    isNew: false,
    features: ["Gym", "Swimming Pool", "Security", "Parking", "Air Conditioning"],
  },
  {
    id: "prop3",
    ...
    imageUrl: "https://cdn.pixabay.com/photo/2018/04/10/06/29/apartment-3306501_1280.jpg",
    status: "For Rent",
    bedrooms: 2,
    bathrooms: 2,
    size: 120,
  ...
  },
  {
    ...
    description: "Luxurious 5 bedroom mansion with state-of-the-art facilities.",
    price: 450000000,
    location: "Banana Island, Lagos",
    imageUrl: "https://peteroz.com.ng/wp-content/uploads/2024/10/Executive-Five-Bedroom-duplex1.jpg",
    status: "For Sale",
    bedrooms: 5,
    bathrooms: 6,
    size: 650,
  ...
  },
  {
    ...
    imageUrl: "https://cdn.pixabay.com/photo/2018/01/05/08/39/furniture-3062400_1280.jpg",
    status: "For Rent",
    bedrooms: 3,
    bathrooms: 3,
    size: 180,
  ...
  },
  {
    ...
    imageUrl: "https://cdn.pixabay.com/photo/2022/07/28/13/52/standing-desk-7349890_1280.jpg",
    status: "For Sale",
    bedrooms: 0,
    bathrooms: 2,
    size: 300,
    isNew: false,
    features: ["Reception Area", "Meeting Rooms", "Parking", "Security", "Elevator"],
  },
]
